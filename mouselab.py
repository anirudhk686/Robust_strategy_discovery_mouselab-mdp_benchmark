...
class MouselabEnv(gym.Env):
    ...
    def __init__(self, tree, init, ground_truth=None, cost=0, sample_term_reward=True,env_type='same',repeat_cost=1,process_model=1):
        self.tree = tree
        self.init = (0, *init[1:])
    ...
    @classmethod
    def new_symmetric(cls, branching, reward_list, seed=None, **kwargs):
